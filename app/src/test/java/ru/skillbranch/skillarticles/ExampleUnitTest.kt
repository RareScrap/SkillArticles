...
class ExampleUnitTest {
    ...
    @Test
    fun parse_quote() { // TODO: Почему Quote содержит во внутренних элементах самого себя, но в виде Text?
    ...
    @Test
    fun parse_italic() { // TODO: Почему Italic содержит во внутренних элементах самого себя, но в виде Text?
    ...
    // TODO: Вывод не соответствует выводу в лекции (урок 5, 1:21:59)
    @Test
    fun parse_rule() {
    ...
    private inline fun <reified T:Element> prepare(list:List<Element>) : List<String>{
        return list // TODO: Как это работает?
